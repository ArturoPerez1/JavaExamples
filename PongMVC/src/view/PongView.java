...
import controller.PongMenuController;
import controller.PongMouseController;
import controller.PongPopupController;
import controller.PongResizeController;
...
/**
 * This along with view.PongPanel implements the view of the simple Pong game.
 *
 * @author bylander
 */
public class PongView extends JFrame {
    ...
    public PongView(PongModel model) {
        ...
        // so the view.PongPanel can listen to the keyboard
     ...
     *
     * @param controller1 a controller.PongMouseController
     * @param controller2 a controller.PongResizeController
     * @param controller3 a controller.PongMenuController
     * @param controller4 a controller.PongPopupController
     */
    public void registerListeners(PongMouseController controller1, PongResizeController controller2, PongMenuController controller3, PongPopupController controller4) {
    ...
    /**
     * @return The size of the view.PongPanel.
     */
